...
- **Snoozz for Safari** ([latest release](https://github.com/verheyenkoen/snoozz/releases/latest))
...
- **Snoozing windows:**
  This requires use of the `tabs` API. Using that API, you will see a privacy popup every single time you try to snooze a website you have not snoozed before. The popup explicitly states _Grant the extension permission to read all your data on this site_ which is going to put off a lot of users.
